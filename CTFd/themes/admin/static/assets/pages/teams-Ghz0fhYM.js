import{$ as e,u as d,C as n,z as u}from"./main-CC-0jmtb.js";function r(l){let t=e("input[data-team-id]:checked").map(function(){return e(this).data("team-id")}),o=t.length===1?"team":"teams";d({title:"Delete Teams",body:`Are you sure you want to delete ${t.length} ${o}?`,success:function(){const a=[];for(var i of t)a.push(n.fetch(`/api/v1/teams/${i}`,{method:"DELETE"}));Promise.all(a).then(s=>{window.location.reload()})}})}function m(l){let t=e("input[data-team-id]:checked").map(function(){return e(this).data("team-id")});u({title:"Edit Teams",body:e(`
